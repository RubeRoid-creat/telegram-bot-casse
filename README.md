...
- **При добавлении средств** можно указать:
  - `500 кол 5` - количество 5 единиц
  - `цена 100` - цена за единицу 100 ₽
  - Полный пример: `500 кол 5 цена 100`
- **При вычитании средств** можно указать:
  - `расход=50` - расходы 50 ₽
  - Пример: `300 расход=50`
- **Аналитика**: отслеживайте:
  - Выручку и прибыль по категориям
  - Расходы при вычитании средств
